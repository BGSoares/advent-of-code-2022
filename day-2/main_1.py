...
# game contains many rounds; in each round, the players each
# simultaneously choose one of Rock, Paper, or Scissors using
# a hand shape. Then, a winner for that round is selected: Rock
# defeats Scissors, Scissors defeats Paper, and Paper defeats
# Rock. If both players choose the same shape, the round instead
# ends in a draw.

# Appreciative of your help yesterday, one Elf gives you an
# encrypted strategy guide (your puzzle input) that they say will
# be sure to help you win. "The first column is what your opponent 
# is going to play: A for Rock, B for Paper, and C for Scissors. 
# The second column--" Suddenly, the Elf is called away to help with 
# someone's tent.
